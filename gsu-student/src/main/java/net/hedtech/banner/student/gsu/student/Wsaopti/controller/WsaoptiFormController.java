...
public class WsaoptiFormController extends DefaultFormController {

	public WsaoptiFormController(ITask task) {
		super(task);
	}
	...
	public void Wsaopti_SaveKeys()
	{
	}

	@ActionTrigger(action="GLOBAL_COPY")
	public void Wsaopti_GlobalCopy()
	{
		// added 
		getFormModel().getKeyBlock().setId(getGlobal("KEY_ID"));	
		getFormModel().getKeyBlock().setTermCode(getGlobal("KEY_TERM"));		
	}

	@ActionTrigger(action="CHECK_KEYS")
	public void Wsaopti_CheckKeys()
	{
	}

	@ActionTrigger(action="DISABLE_KEYS")
	public void Wsaopti_DisableKeys()
	{	
		
	}

	@ActionTrigger(action="ENABLE_KEYS")
	public void Wsaopti_EnableKeys()
	{		
		
	}

	@ActionTrigger(action="WHEN_NEW_BLOCK_INSTANCE_TRG")
	public void Wsaopti_WhenNewBlockInstanceTrg()
	{	
	...
	public void Wsaopti_LoadCurrentRelease()
	{	
/*		getFormModel().getFormHeader().setCurrentRelease(toStr("8.5"));*/
	...
	public void Wsaopti_NextBlock()
	{
		getGFormClass().nextBlock();
	}

	@ActionTrigger(action="G$_VERIFY_ACCESS")
	public void Wsaopti_GVerifyAccess()
	{
		getGFormClass().gVerifyAccess();
	}

	@TaskStartedPre
	public void Wsaopti_TaskStartedPre(EventObject args)
	{
		getGFormClass().taskStartedPre(args);
	}

	@ActionTrigger(action="PRE_FORM_TRG")
	public void Wsaopti_PreFormTrg()
	{
		getGFormClass().preFormTrg();
	}

	@TaskEnded
	public void Wsaopti_TaskEnded(EventObject args)
	{
		getGFormClass().taskEnded(args);
	}

	@ActionTrigger(action="POST_FORM_TRG")
	public void Wsaopti_PostFormTrg()
	{
	...
	@Before
	public void Wsaopti_blockIn()
	{
		getGFormClass().blockIn();
	}

	@ActionTrigger(action="PRE_BLOCK_TRG")
	public void Wsaopti_PreBlockTrg()
	{
	...
	@Before
	public void Wsaopti_blockOut()
	{
		getGFormClass().blockOut();
	}

	@ActionTrigger(action="POST_BLOCK_TRG")
	public void Wsaopti_PostBlockTrg()
	{
		getGFormClass().postBlockTrg();
	}

	@BeforeCommit
	public void Wsaopti_BeforeCommit(CancelEvent args)
	{
		getGFormClass().beforeCommit(args);
	}

	@ActionTrigger(action="PRE_COMMIT_TRG")
	public void Wsaopti_PreCommitTrg()
	{
		getGFormClass().preCommitTrg();
	}

	@OnRollback
	public void Wsaopti_OnRollback(EventObject args)
	{
		getGFormClass().onRollback();
	}

	@ActionTrigger(action="ON_ROLLBACK_TRG")
	public void Wsaopti_OnRollbackTrg()
	{
		getGFormClass().onRollbackTrg();
	}

	@ActionTrigger(action="ON-SELECT")
	public void Wsaopti_OnSelect()
	{
		getGFormClass().onSelect();
	}

	@AfterCommit
	public void Wsaopti_AfterCommit(EventObject args)
	{
		getGFormClass().afterCommit(args);
	}

	@ActionTrigger(action="POST_FORMS_COMMIT_TRG")
	public void Wsaopti_PostFormsCommitTrg()
	{
		getGFormClass().postFormsCommitTrg();
	}

	@ActionTrigger(action="WHEN-BUTTON-PRESSED")
	public void Wsaopti_buttonClick()
	{
		getGFormClass().click();
	}
	...
	@Before
	public void Wsaopti_blockChange()
	{
		getGFormClass().blockChange();
	}

	@ActionTrigger(action="WHEN-WINDOW-ACTIVATED")
	public void Wsaopti_WhenWindowActivated()
	{
		getGFormClass().whenWindowActivated();
	}

	@ActionTrigger(action="WHEN-WINDOW-CLOSED")
	public void Wsaopti_WhenWindowClosed()
	{
		getGFormClass().whenWindowClosed();
	}

	@ActionTrigger(action="KEY-PRVBLK", function=KeyFunction.PREVIOUS_BLOCK)
	public void Wsaopti_PreviousBlock()
	{
		getGFormClass().previousBlock();
	}

	@ActionTrigger(action="KEY-LISTVAL", function=KeyFunction.LIST_VALUES)
	public void Wsaopti_ListValues()
	{
	...
	public void Wsaopti_ListValuesCopy()
	{
