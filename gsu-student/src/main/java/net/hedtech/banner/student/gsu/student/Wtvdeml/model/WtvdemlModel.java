...
public class WtvdemlModel extends FormModel {
	
	public WtvdemlModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvdeml() {
		return (IDBBusinessObject) getBusinessObject("WTVDEML");
	}
