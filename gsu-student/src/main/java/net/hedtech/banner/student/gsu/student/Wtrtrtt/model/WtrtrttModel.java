...
public class WtrtrttModel extends FormModel {
	
	public WtrtrttModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtrtrtt() {
		return (IDBBusinessObject) getBusinessObject("WTRTRTT");
	}
