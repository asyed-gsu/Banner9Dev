...
public class WtvlocnModel extends FormModel {
	
	public WtvlocnModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvlocn() {
		return (IDBBusinessObject) getBusinessObject("WTVLOCN");
	}
}