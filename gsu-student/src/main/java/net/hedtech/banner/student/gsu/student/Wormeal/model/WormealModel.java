...
public class WormealModel extends FormModel {
	
	public WormealModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWbrmeal() {
		return (IDBBusinessObject) getBusinessObject("WBRMEAL");
	}
