...
public class WorschpModel extends FormModel {
	
	public WorschpModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWbschrt() {
		return (IDBBusinessObject) getBusinessObject("WBSCHRT");
	}
