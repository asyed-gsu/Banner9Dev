...
public class WoalocnModel extends FormModel {
	
	public WoalocnModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWorlocn() {
		return (IDBBusinessObject) getBusinessObject("WORLOCN");
	}
