...
public class WuasrveModel extends FormModel {
	
	public WuasrveModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWursrve() {
		return (IDBBusinessObject) getBusinessObject("WURSRVE");
	}
	...
	public IDBBusinessObject getWursrvx() {
		return (IDBBusinessObject) getBusinessObject("WURSRVX");
	}
}