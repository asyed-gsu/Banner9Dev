...
public class WtvsrvgModel extends FormModel {
	
	public WtvsrvgModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvsrvg() {
		return (IDBBusinessObject) getBusinessObject("WTVSRVG");
	}
}