...
public class WtvsrvyModel extends FormModel {
	
	public WtvsrvyModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvsrvy() {
		return (IDBBusinessObject) getBusinessObject("WTVSRVY");
	}
}