...
public class WtvtrtgModel extends FormModel {
	
	public WtvtrtgModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvtrtg() {
		return (IDBBusinessObject) getBusinessObject("WTVTRTG");
	}
}