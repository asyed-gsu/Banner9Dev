...
public class WtvooctModel extends FormModel {
	
	public WtvooctModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvooct() {
		return (IDBBusinessObject) getBusinessObject("WTVOOCT");
	}
}