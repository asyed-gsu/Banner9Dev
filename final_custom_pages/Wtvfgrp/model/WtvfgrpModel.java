...
public class WtvfgrpModel extends FormModel {
	
	public WtvfgrpModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWtvfgrp() {
		return (IDBBusinessObject) getBusinessObject("WTVFGRP");
	}
}