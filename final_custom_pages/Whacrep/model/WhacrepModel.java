...
public class WhacrepModel extends FormModel {
	
	public WhacrepModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getWhbcrep() {
		return (IDBBusinessObject) getBusinessObject("WHBCREP");
	}
